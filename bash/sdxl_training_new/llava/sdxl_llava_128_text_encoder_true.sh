...
###############################################################################
#BSUB -J train_llava_text_encoder_rank_128_text_encoder_true
#BSUB -q gpua100
#BSUB -W 24:00
#BSUB -n 4
#BSUB -R "rusage[mem=32GB] span[hosts=1]"
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -o bash/bash_outputs/train_llava_text_encoder_rank_128_text_encoder_true.%J.out
#BSUB -e bash/bash_outputs/train_llava_text_encoder_rank_128_text_encoder_true.%J.err
#BSUB -B
#BSUB -N
