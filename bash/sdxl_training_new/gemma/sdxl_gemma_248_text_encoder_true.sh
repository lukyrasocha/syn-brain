...
###############################################################################
#BSUB -J train_gemma_text_encoder_rank_248_text_encoder_true
#BSUB -q gpua100
#BSUB -W 24:00
#BSUB -n 4
#BSUB -R "rusage[mem=32GB] span[hosts=1]"
#BSUB -gpu "num=1:mode=exclusive_process"
#BSUB -o bash/bash_outputs/train_gemma_text_encoder_rank_248_text_encoder_true.%J.out
#BSUB -e bash/bash_outputs/train_gemma_text_encoder_rank_248_text_encoder_true.%J.err
#BSUB -B
#BSUB -N
...
OUTPUT_DIR="$PROJECT_DIR/models/gemma_${LSB_JOBID}_${RANK}_gpua100_$( [ $TRAIN_TEXT_ENCODER = true ] && echo text_encoder || echo unet_only )_fixed"
mkdir -p "$OUTPUT_DIR"

VALID_PROMPT="tumor: yes; location: cerebellar; size: large; shape: irregular; intensity: hypodense; orientation: saggital; general description: MRI shows a large cerebellar mass with surrounding edema, compressing the brainstem. Ventricles appear normal."
...
accelerate launch --config_file "$ACCEL_CFG" src/train_lora_sdxl.py \
  ...
  --metadata_file "$PROJECT_DIR/data/preprocessed_json_files/metadata_gemma_better.jsonl" \
  --image_column image \
