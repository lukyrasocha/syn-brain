...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sd_llava_rank_248                                  # job name
...
#BSUB -o bash/bash_outputs/train_sd_llava_rank_248.%J.out         # stdout
#BSUB -e bash/bash_outputs/train_sd_llava_rank_248.%J.err         # stdout
