...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sd_llava_rank_64                                  # job name
...
#BSUB -o bash/bash_outputs/train_sd_llava_rank_64.%J.out         # stdout
#BSUB -e bash/bash_outputs/train_sd_llava_rank_64.%J.err         # stdout
