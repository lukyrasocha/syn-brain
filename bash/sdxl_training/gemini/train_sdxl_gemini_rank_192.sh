...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sdxl_gemini_rank_192                                     # job name
...
#BSUB -o bash/bash_outputs/train_sdxl_gemini_rank_192.%J.out       # stdout
#BSUB -e bash/bash_outputs/train_sdxl_gemini_rank_192.%J.err       # stdout
