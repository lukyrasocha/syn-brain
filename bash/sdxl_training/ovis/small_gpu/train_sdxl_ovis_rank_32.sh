...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sdxl_ovis_rank_32                                     # job name
...
#BSUB -o bash/bash_outputs/train_sdxl_ovis_rank_32.%J.out       # stdout
#BSUB -e bash/bash_outputs/train_sdxl_ovis_rank_32.%J.err       # stdout
