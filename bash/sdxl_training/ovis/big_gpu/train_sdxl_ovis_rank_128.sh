...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sdxl_ovis_rank_128                                     # job name
...
#BSUB -o bash/bash_outputs/train_sdxl_ovis_rank_128.%J.out       # stdout
#BSUB -e bash/bash_outputs/train_sdxl_ovis_rank_128.%J.err       # stdout
...
OUTPUT_DIR="/dtu/blackhole/17/209207/ovis/model_${LSB_JOBID}_${RANK}_gpua100"


VALID_PROMPT="Tumor: yes; location: left hemisphere; size: large; shape: regular; intensity: hyperintense; orientation: axial; general description: brain MRI shows a hyperintense glioma in the left hemisphere, with surrounding edema and midline shift. No other abnormalities are visible." \
