...
###                       Job Configuration                       ###
### ————————————————————————————————————————————————————————————— ###
#BSUB -J train_sdxl_llava_rank_128                                     # job name
...
#BSUB -o bash/bash_outputs/train_sdxl_llava_rank_128.%J.out       # stdout
#BSUB -e bash/bash_outputs/train_sdxl_llava_rank_128.%J.err       # stdout
...
OUTPUT_DIR="/dtu/blackhole/17/209207/llava/model_${LSB_JOBID}_${RANK}_gpuv100"
